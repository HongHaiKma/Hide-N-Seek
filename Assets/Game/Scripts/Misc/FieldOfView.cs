...
public class FieldOfView : MonoBehaviour
{
    ...
    [HideInInspector] public List<Transform> visibleFakeTargets = new List<Transform>();
    ...
    void DrawFieldOfView()
    {
        ...
        {
            float angle = transform.eulerAngles.y - viewDrawingAngle / 2 + stepAngleSize * i;
